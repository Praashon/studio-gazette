...
export default async function HomePage() {
  ...
  return (
    <>
              ...
              <div className="space-y-0">
                {latestArticles.slice(3, 8).map((article) => (
                  <Link
                    ...
                    className="flex gap-6 group py-5 border-b border-zinc-100 hover:bg-surface-container-low transition-colors duration-200 -mx-3 px-3"
                  >
                    {article.image_url && (
                      <div className="w-28 h-20 shrink-0 overflow-hidden bg-zinc-100">
                        <img
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-headline font-bold text-lg leading-tight group-hover:text-primary-container transition-colors duration-200 line-clamp-2">
                        {article.title}
                      </h3>
      ...
      {/* Op-Ed Banner */}
      <section className="bg-on-surface text-white py-24">
        <div className="max-w-[1440px] mx-auto px-6 flex flex-col lg:flex-row gap-16 items-center">
          <div className="lg:w-1/2">
            ...
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-headline font-bold mb-8 leading-[0.92] tracking-tight">
              {opEdArticle?.title || "The Future of Collaborative Data"}
            </h2>
            <p className="text-base md:text-lg font-body text-zinc-400 leading-relaxed mb-12 max-w-xl">
              {opEdArticle?.excerpt ||
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 bg-white text-black px-10 py-4 font-label font-bold uppercase tracking-[0.12em] text-sm hover:bg-primary-container hover:text-white transition-all duration-300"
            >
              Full Story
      ...
      <section className="max-w-3xl mx-auto px-6 py-24">
        <h2 className="text-2xl md:text-3xl font-headline font-bold mb-12 text-center uppercase tracking-[0.08em] border-y border-zinc-200 py-4">
          Reader Inquiries
        </h2>
        <div className="space-y-0">
          {[
            {
              ...
              a: "We aggregate from curated RSS feeds of trusted global news sources including TechCrunch, BBC, The Verge, Reuters, and more. You can also add your own feeds from the Feeds page. Every article links back to its original source.",
            },
            {
            ...
            },
            {
              ...
              a: "Yes! Visit the Feeds page to add any RSS feed URL. We'll validate it, fetch articles from it, and include them in your reading experience.",
            },
            {
              q: "Can I bookmark articles?",
              a: "Yes! Click the bookmark icon on any article card to save it for later. Visit the Bookmarks page to see all your saved articles. Bookmarks are stored locally in your browser for privacy.",
            },
          ].map((faq, i) => (
            <details
              key={i}
              ...
              open={i === 0}
            >
              <summary className="flex justify-between items-center py-6 cursor-pointer list-none hover:text-primary-container transition-colors">
                <span className="text-lg font-headline font-bold italic pr-4">
                  {faq.q}
                </span>
                <span className="material-symbols-outlined group-open:rotate-180 transition-transform duration-300 text-primary-container shrink-0">
                  expand_more
                </span>
              </summary>
